                ...
                <form className={'etc-form'}>
                    <div className="form-section">
                        <DropDownContent title={'Прочее'}>
                            <FormArrayField values={formProps.values.items} name={'items'} renderChild={
                                (key, index) => (
                                    <div>
                                        <Row gutter={16}>
                                            <Col>
                                            ...
                                            <Col>
                                                <FormField label={'Дата'}>
                                                    <DatePicker onChange={formProps.handleChange} value={moment(formProps.values.items[index]?.date)}/>
                                                </FormField>
                                            </Col>
                                        </Row>
                                        <Row>
